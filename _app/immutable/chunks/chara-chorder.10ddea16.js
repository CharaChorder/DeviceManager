...
Characters from the opposite hand are mirrored to the hand which activates this feature.
`},544:{variantOf:36,id:"SPACERIGHT",display:" ",title:"Right Spacebar (eg CC Lite)",icon:"space_bar",variant:"right"},548:{id:"KM_1_L",title:"Primary Keymap",icon:"counter_1",variant:"left"},549:{variantOf:548,id:"KM_1_R",title:"Primary Keymap",icon:"counter_1",variant:"right"},550:{id:"KM_2_L",title:"Numeric Layer",icon:"counter_2",variant:"left"},551:{variantOf:550,id:"KM_2_R",title:"Numeric Layer",icon:"counter_2",variant:"right"},552:{id:"KM_3_L",title:"Function Layer",icon:"counter_3",variant:"left"},553:{variationOf:552,id:"KM_3_R",title:"Function Layer",icon:"counter_3",variant:"right"},576:{id:"ACTION_DELAY_1000",icon:"clock_loader_90",description:"Wait for one second"},577:{id:"ACTION_DELAY_100",icon:"clock_loader_60",description:"Wait for 100 milliseconds"},578:{id:"ACTION_DELAY_10",icon:"clock_loader_40",description:"Wait for 10 milliseconds"},579:{id:"ACTION_DELAY_1",icon:"clock_loader_10",description:"Wait for one millisecond"}}};export{e as default};
//# sourceMappingURL=chara-chorder.10ddea16.js.map
